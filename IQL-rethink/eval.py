...
if __name__ == '__main__':
    ...
    parser.add_argument('--env-name', default="kitchen-mixed-v0")
    ...
    parser.add_argument('--load-policy', type=str, default="log/kitchen-mixed-v0/11-12-24_11.26.32_jplp/policy-399999.pt")
